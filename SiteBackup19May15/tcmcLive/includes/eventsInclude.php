...
//if($_SESSION['userType'] === "admin"){
    ...
    echo "Event Name*: <input type='text' name='eventName' required> <br />";
    echo "Event Time*: <input type='text' name='eventTime' required> <br />";
    echo "Event Date*: <input type='date' name='eventDate' required> <br />";
    echo "Event Location*: <input type='text' name='eventLocation' required> <br />";
    echo "Event Contact Name: <input type='text' name='eventContactName'> <br />";
    echo "Event Contact Phone: <input type='text' name='eventPhone' /> <br />";
    echo "<textarea form='addEventForm' name='eventDesc'> </textarea> <br />";
...
foreach ($dbh->query($sql) as $row) {
    ...
    if ($_POST['edit'] === $row['eventID']) {
        ...
        if ($row['eventTime'] > 12) {
            $time = ($row['eventTime'] - 12) . " pm";
        } else {
            $time = ($row['evenTime']) . " am";
        }
        echo "<a name='$row[eventID]'></a>";
        echo "<div>";
