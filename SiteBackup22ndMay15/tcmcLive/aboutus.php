    ...
    ?>
        ...
        <div class="Content">
            <h2>About Us</h2>
            <p id="sub">
            <strong>Looking Back - The first 30 years!</strong>
            </p>
      <br>      <p>            The <strong id="ital">Townsville Community Music Centre</strong> celebrated its 30th year in 2013. <br>
            ...
            <hr>
            <img src="images/OLDGCBF15091.gif" id="sponsor">
            <p>
            <strong>Queensland Government</strong><br><br>
