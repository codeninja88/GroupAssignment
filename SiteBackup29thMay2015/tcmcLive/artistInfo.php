...
<?php
    ...
    if (($postType != 'Edit') && ($postType != 'Save') && ($postType != 'Add') && ($postType != 'Delete')) {
        ...
        foreach ($dbh->query($sql) as $row) {
            ...
            echo "<div id='artistInfoMiddleLeft'>";
            if ($row['artistImg'] != null) {
                echo "<label for='artistImg'><a href='images/" . $row['artistImg'] . "'>Enlarge</a></label>";
                echo "<br>";

                echo "<img class='imgBorder' alt='artist Image' src='images/musosThumbnail/";
                echo $row['artistImg'];
                echo "' id='artistImg'/>";
                ...
                echo "<img class='imgBorder' alt='artist image' src='images/musosThumbnail/defaultThumbnail.png'/>";
            }
