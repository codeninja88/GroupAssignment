        ...
        <div id="artistMainContent">
            ...
            <?php
                ...
                || ($_SESSION['userType'] == 'admin'))) {
                    echo "<form method='GET' action='artistNew.php'>";
            ...
            <div id="artistListDiv">
                <?php
                    ...
                    echo "<table id='artistListTable' border='1'>";
                    ...
                    foreach ($dbh->query($sql) as $row) {
                        echo '<tr>';
                            ...
                            if ($row['artistImg'] != null) {
                                echo "<img alt='Artist Image' src='images/musosThumbnail/";
                                echo $row['artistImg'];
                                echo "'/>";
                            } else {
                            echo "<img alt='Artist Image' src='images/musosThumbnail/defaultThumbnail.png'/>";
                            }
                            echo '</td>';
