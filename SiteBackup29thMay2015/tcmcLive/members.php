    ...
    <form action="signUpApplicationHandler.php" id="signupApplicationForm" method="post">
        <table id="signupTable">
            <tr>
                ...
                <td class="rightSignUpColumn"><input type="email" id="userEmail" name="username"  size="25" placeholder="someone@somewhere.com"
                           required/></td>
            </tr>
            <tr>
                <td>Password*:</td>
                <td class="rightSignUpColumn"><input type="password" name="password" id="passwordInput" size="25" required/><span id="passwordErrorSpan"></span></td>
                
            </tr>
            <tr>
                <td>Confirm Password*:</td>
                <td class="rightSignUpColumn"><input type="password" name="password" id="confirmPasswordInput" size="25" required/></td>
                
            </tr>
            <tr>
                <td>First Name*:</td>
                <td class="rightSignUpColumn"><input type="text" name="userFName" size="25" required/></td>
            </tr>
            <tr>
                <td>Surname*:</td>
                <td class="rightSignUpColumn"><input type="text" name="userLName" size="25" required/></td>
            </tr>
            <tr>
                <td>Phone Number:</td>
                <td class="rightSignUpColumn"><input type="text" name="userPrimPhone" size="25"/></td>
            </tr>
            <tr>
                <td>Secondary Phone Number:</td>
                <td class="rightSignUpColumn"><input type="text" name="userSecPhone" size="25"/></td>
            </tr>
            <tr>
                <td>Mobile Phone:</td>
                <td class="rightSignUpColumn"><input type="text" name="userMobile" size="25"/></td>
            </tr>
            <tr>
                <td>Address:</td>
                <td class="rightSignUpColumn"><textarea id="userAddress" name="userAddress" form="signupApplicationForm" value='' cols="50" rows="10"></textarea></td>
            </tr>
        </table>


        User Type:<br />
         <input type="radio" name="userType" value="casual" checked="checked"/>Casual<br />
         <input type="radio" name="userType" value="paid"/>Paid <br />
        <input type="submit" id="signupButton" class="signUpSubmitButton" name="Signup" value="Signup">
